                ...
                <article className="mt-[310px] lg:mt-0 lg:mr-4">
                    ...
                    <div className="grid grid-cols-3 lg:grid-cols-5 gap-1">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-slate-400 mt-2">Next Js</p>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <img src={NestJs} alt='kosong' className="h-6 mt-2"></img>
                            <p className="text-slate-400 mt-2">Nest Js</p>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <img src={Laravel} alt='kosong' className="h-6 mt-2"></img>
                            <p className="text-slate-400 mt-2">Laravel</p>
                        </div>
                    </div>
                    <br />
                    <div className="flex">
                    ...
                    <div className="grid grid-cols-3 lg:grid-cols-5 gap-1">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-slate-400 mt-2">Gitlab</p>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <img src={Docker} alt='kosong' className="h-5 mt-2"></img>
                            <p className="text-slate-400 mt-2">Docker</p>
                        </div>
                    </div>
                    <br />
                    <div className="flex">
                    ...
                    <div className="grid grid-cols-3 lg:grid-cols-5 gap-1">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-slate-400 mt-2">PostgresSQL</p>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <img src={MongoDb} alt='kosong' className="h-5 mt-2"></img>
                            <p className="text-slate-400 mt-2">MongoDB</p>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <img src={Redist} alt='kosong' className="h-5 mt-2"></img>
                            <p className="text-slate-400 mt-2">Redist</p>
                        </div>
                    </div>
                </article>
            </div>
